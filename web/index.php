        ...
        case 'message':
            ...
            switch ($message['type']) {
                case 'text':
                    ...
                    $emoticon=unichr(0x1000B6);
                    $r_message=urlencode('嗨！毛毛'.$emoticon.'~\n你是來領取點數的嗎？要跟我說通關密語哦');
                        if( strpos( $message['text'], '點數' ) !== false || strpos( $message['text'], '查' ) !== false){
                            ...
                            $r_message=urlencode('毛毛現在總共有 '.$count.' 點了耶耶!'.$emoticon);
                            if($count>=3){
